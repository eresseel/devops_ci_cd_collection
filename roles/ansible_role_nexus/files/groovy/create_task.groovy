...
TaskConfiguration taskConfiguration = taskScheduler.createTaskConfigurationInstance(parsed_args.type_id)
taskConfiguration.setName(parsed_args.name)

parsed_args.task_properties.each { key, value -> taskConfiguration.setString(key, value) }
